    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="border-b border-border/50 bg-background/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center gap-2 h-14">
          <div className="w-8 h-8 rounded-md bg-primary/20 flex items-center justify-center cursor-pointer" onClick={() => navigate("/")} data-testid="link-home-logo">
        ...
        <div className="w-full max-w-lg text-center">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-8">
              Our AI is searching billions of images across the web
            </p>
