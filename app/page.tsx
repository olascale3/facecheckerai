    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-28 pb-20 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <motion.h1
            className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-6 leading-[1.1] text-balance"
                  ...
                  {!preview ? (
                    ...
                    <motion.div key="preview" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="space-y-4">
                      ...
                      <div className="flex gap-3 justify-center flex-wrap">
                        <Button onClick={handleSearch} disabled={uploading} data-testid="button-search-face">
                          {uploading ? (
                            <>
                        ...
                        <Button variant="outline" onClick={() => { setPreview(null); if (fileInputRef.current) fileInputRef.current.value = ""; }} data-testid="button-clear-photo">
